...
function DeliveryAddress({ addressItem, order }) {
    ...
    const onSubmit = async (data, e) => {
        ...
        await dispatch(updateAddress(formData, addressItem._id))
    }
                        ...
                        {JSON.parse(addressItem.isDefault) ? (
                            ...
                            <>
                                <IconCustomer isDelete>
                                    <FiTrash onClick={() => handleRemoveAddress(addressItem)} />
                                </IconCustomer>
                            </>
                        )}
                    </>
